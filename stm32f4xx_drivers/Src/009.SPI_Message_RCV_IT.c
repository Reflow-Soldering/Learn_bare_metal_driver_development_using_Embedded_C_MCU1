...
void SPI2_Inits(void)
{
	...
	SPI2handle.SPI_PinConfig.SPI_SclkSpeed = SPI_SCLK_DIV_32;
...
void Slave_GPIO_InterruptPinInit(void)
{
	...
	spiIntPin.GPIO_PinConfig.GPIO_PinMode = GPIO_MODE_INT_FT;
	spiIntPin.GPIO_PinConfig.GPIO_PinSpeed = OUTPUT_SPD_LOW;
